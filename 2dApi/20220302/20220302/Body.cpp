...

{
	...
	GetCollider()->SetScale(Vec2(18.f, 10.f));
	...
	GetAnimator()->CreateAnimation(L"BODY_LEFT", m_pTex, Vec2(15.f, 123.f), Vec2(18.f, 13.f), Vec2(34.f, 0.f), 0.05f, 5);
	GetAnimator()->CreateAnimation(L"BODY_RIGHT", m_pTex, Vec2(176.f, 123.f), Vec2(18.f, 13.f), Vec2(34.f, 0.f), 0.05f, 5);
	


	PlayAnim(m_pAnim, m_strAnimName, Vec2(0.f, 15.f));
}
